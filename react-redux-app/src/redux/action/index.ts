...
//  search action
export const GET_ASYNC_SEARCH_BLOGS_START = 'GET_ASYNC_SEARCH_BLOGS_START' as const;
export const GET_ASYNC_BLOGS_SEARCH_SUCCESS = 'GET_ASYNC_BLOGS_SEARCH_SUCCESS' as const;
export const GET_ASYNC_BLOGS_SEARCH_FAILURE = 'GET_ASYNC_BLOGS_SEARCH_FAILURE' as const;
...
export const GET_ASYNC_TOTAL_COUNT_FAILURE = 'GET_ASYNC_TOTAL_COUNT_FAILURE' as const

// count news

export const SET_CURRENT_NEWS_PAGE = 'SET_CURRENT_NEWS_PAGE' as const;
export const GET_ASYNC_TOTAL_COUNT_NEWS = 'GET_TOTAL_COUNTGET_ASYNC_TOTAL_COUNT_NEWS' as const;
export const GET_ASYNC_TOTAL_COUNT_NEWS_FAILURE = 'GET_ASYNC_TOTAL_COUNT_NEWS_FAILURE' as const